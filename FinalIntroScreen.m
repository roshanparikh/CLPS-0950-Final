...
Screen('Flip', window);
DrawFormattedText(window, 'Welcome to Brain Pain Strain Game - choose which task you want to play! \n\n For RGB Anomaloscope, press the up key! \n\n For Priming Test, press the down key! \n\n For Stroop Test, press the left key! \n\n For the Working Memory Test, press the right key! \n\n  You can quit anytime by pressing ESC!',xCenter-300, yCenter-100, black); %game menu
Screen('Flip', window);
KbStrokeWait
